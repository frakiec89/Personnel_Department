        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateRegistrations = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudenOfOrphant", x => x.StudentId);
                    table.ForeignKey(
                        name: "FK_StudenOfOrphant_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                name: "StudentOfDisabled",
                columns: table => new
                {
                    StudentId = table.Column<int>(type: "int", nullable: false),
                    StudentOfDisabledId = table.Column<int>(type: "int", nullable: false),
                    TypeDisabled = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentOfDisabled", x => x.StudentId);
                    table.ForeignKey(
                        name: "FK_StudentOfDisabled_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Restrict);
